        ...
        <div className="flex flex-col gap-12 justify-between ">
          ...
          <div className="w-full md:w-full px-4 mb-8 flex lg:flex-row flex-col">
            ...
            <div className="text-white">
              ...
              <p className="text-background">
                Votre site web peut être facilement mis à jour et évoluer au fil
                du temps, vous permettant d'ajouter de nouvelles fonctionnalités
                et de répondre aux besoins changeants de votre entreprise et de
                vos clients.
              </p>
            </div>
          </div>
          <div className="w-full md:w-full px-4 mb-8 flex lg:flex-row flex-col">
            ...
            <div className="text-white">
              ...
              <p className="text-background">
                Disponible 24/7, votre site web offre une accessibilité totale à
                vos produits ou services. Vos clients potentiels peuvent vous
                trouver et consulter vos offres à tout moment, même en dehors
